...
public class SetMenuActivity extends AppCompatActivity implements
        ...
        mButton01Show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (intent != null) {
                    ...
                    Toast.makeText(SetMenuActivity.this, "ラジオボタンが選択されていません。", Toast.LENGTH_SHORT).show();
                }
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        switch (checkedId) {
            case R.id.radioButton01Product:         // 品名一覧(ListView×ArrayAdapter)を選択した場合
                intent = new Intent(SetMenuActivity.this, SelectSheetProduct.class);
                break;
            case R.id.radioButton01ListView:        // ListView表示を選択した場合
                intent = new Intent(SetMenuActivity.this, SelectSheetListView.class);
                break;
            case R.id.radioButton01TableLayout:     // TableLayout表示を選択した場合
                intent = new Intent(SetMenuActivity.this, SelectSheetTable.class);
                break;
        }
    }
    ...
    private void saveList() {
        ...
        if (strProduct.equals("") || strMadeIn.equals("") || strNumber.equals("") || strPrice.equals("")) {
            ...
            Toast.makeText(SetMenuActivity.this, "※の箇所を入力して下さい。", Toast.LENGTH_SHORT).show();
            ...
            dbAdapter.saveDB(strProduct, strMadeIn, strNumber, strPrice);   // DBに登録
