...
import com.example.bottomnav.food_mng.Fitness;
import com.example.bottomnav.food_mng.FoodNameHelper;
import com.example.bottomnav.food_mng.HomeActivity;
import com.example.bottomnav.food_mng.KcalHelper;

import com.example.bottomnav.food_mng.Non_CustomAdapter;
import com.example.bottomnav.food_mng.SubActivity2;
import com.example.bottomnav.food_mng.SubActivity4;
...
public class FoodFragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match(自分で適した名前に変えて)
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    // TODO: Rename and change types of parameters(自分で適した名前に変えて)
...
//    ここまで
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        t3 = view.findViewById(R.id.textView14);
        t4 = view.findViewById(R.id.textView25);
        t5 = view.findViewById(R.id.textView23);
        t6 = view.findViewById(R.id.textView22);
        aim_cal = view.findViewById(R.id.aim_cal2);
        aim_cal1 = view.findViewById(R.id.aim_cal1);

        textdate = view.findViewById(R.id.datetext_ff);
        textdate2 = textdate.getText().toString();

        redayButton = view.findViewById(R.id.redaybtn);

        final TextView dateText = view.findViewById(R.id.datetext_ff);
...
//                        return true;
//                    case R.id.fitness:
//                        startActivity(new Intent(getActivity().getApplicationContext(), Fitness.class));
//                        overridePendingTransition(0,0);
//                        return true;
//
//                }
...
//        });
                ...
                switch (item.getItemId()) {
                    case R.id.menuBody:
                        Intent intent2 = new Intent(
                                getActivity().getApplication(), SubActivity2.class);
                    ...
                    case R.id.menuBreakfast:
                        Intent intent3 = new Intent(
                                getActivity().getApplication(), SubActivity3.class);
                        global.setMealString("朝食");
                        startActivity(intent3);
                        return true;
                    case R.id.menuLunch:
                        Intent intent4 = new Intent(
                                getActivity().getApplication(), SubActivity3_2.class);
                        global.setMealString("昼食");
                        startActivity(intent4);
                        return true;
                    case R.id.menuSnack:
                        Intent intent5 = new Intent(
                                getActivity().getApplication(), SubActivity3_3.class);
                        global.setMealString("間食");
                        startActivity(intent5);
                        return true;
                    case R.id.menuDinner:
                        Intent intent6 = new Intent(
                                getActivity().getApplication(), SubActivity3_4.class);
                        global.setMealString("夕食");
                        startActivity(intent6);
                        return true;
                    case R.id.menuExercise:
                        Intent intent7 = new Intent(
                                getActivity().getApplication(), SubActivity4.class);
                        ...
                        DatePickerDialog datePickerDialog = new DatePickerDialog(     //DatePickerDialogインスタンスを取得
                                ...
                                new DatePickerDialog.OnDateSetListener() {
                                    ...
                                    public void onDateSet(DatePicker view, final int year, final int month, final int dayOfMonth) {
                                        ...
                                        Button nextdayButton = view.findViewById(R.id.nextdaybtn);
    ...
    public  void  Mokuhyou(String type, String data) {
        ...
        if(data != null) {
            ...
            Toast.makeText(getActivity().getApplication(),"目標摂取カロリーを入力してください",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void getKcal(){
        ...
        date6 = null;
        if (helper3 == null) {
            helper3 = new KcalHelper(getActivity().getApplicationContext());
        }
    ...
    private void getDailyCal(){
        ...
        if (helper == null) {
            helper = new TestOpenHelper2(getActivity().getApplicationContext());
        }
        try (SQLiteDatabase db = helper.getWritableDatabase()) {
            ...
            textView5 = view.findViewById(R.id.kal);
            String d = correct_cal + "kcal";
            textView5.setText(d);

        }

        NonScrollListView nonListView = view.findViewById(R.id.shokuhinn);
        Non_CustomAdapter adapter = new Non_CustomAdapter(getActivity().getApplicationContext(), R.layout.f_mng_list, (ArrayList<String>) food_list, (ArrayList<String>) cal_list);
    ...
    private void drawGraph(){
        ...
        PieChart pieChart1 = view.findViewById(R.id.pie_chart2);
