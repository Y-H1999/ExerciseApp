...
public class SubActivity3_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(helper2 == null){
                    helper2 = new TestOpenHelper2(SubActivity3_2.this);
                }//編集ボタン等の動作
    ...
    private void requestPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ActivityCompat.requestPermissions(SubActivity3_2.this,
    ...
    public void getImage(){
        if(helper4 == null){
            helper4 = new TestOpenHelper4(SubActivity3_2.this);
        }
    ...
    private void expansionPic(final Uri uri1){
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImageView imageView = new ImageView(SubActivity3_2.this);
                Bitmap bitmap = null;
                try {
                ...
                Dialog dialog = new Dialog(SubActivity3_2.this);
